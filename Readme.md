...
# Parsing + Configuration Script – SMTPBEU868 - Rev. A

This **Parsing + Configuration** script is designed for the **SMTPBEU868** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – SMTPBEU868 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **SMTPBEU868** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
